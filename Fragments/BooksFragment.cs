...
namespace com.companyname.navigationgraph9net9.Fragments
{
    public class BooksFragment : Fragment, IMenuProvider, IOnApplyWindowInsetsListener
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup? container, Bundle? savedInstanceState)
        {
            ...
            if (OperatingSystem.IsAndroidVersionAtLeast(29))    // Android 10 - Build.VERSION_CODES.Q
        ...
        public WindowInsetsCompat OnApplyWindowInsets(View v, WindowInsetsCompat insets)
        {
            if (v is RecyclerView)
            {
                ...
                if (IsGestureNavigation(insets)) // change from ! and swap them around - dont't forget the preference needs to be disable for A15 devices
